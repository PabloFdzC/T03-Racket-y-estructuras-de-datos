...
Ejemplo:
-(find-node (insert-node (insert-node (insert-node (node 1 "a" "a") 1 2 "b" "b" 10) 1 3 "c" "c" 20) 3 4 "d" "d" 30) 3)
-   devuelve '(3 "c" "c")
|#
  ...
  (cond
    ...
    [else (list (car tree)
                (for/list ([elem (cadr tree)])
                  (edge (insert-node (car elem) parent id name value weight) (cdr elem))
                  )
                )]
    ))
...
- Se devuelve los datos del nodo
Ejemplo:
-(find-node (insert-node (insert-node (insert-node (node 1 "a" "a") 1 2 "b" "b") 1 3 "c" "c") 3 4 "d" "d") 3)
-   devuelve '(3 "c" "c")
|#
